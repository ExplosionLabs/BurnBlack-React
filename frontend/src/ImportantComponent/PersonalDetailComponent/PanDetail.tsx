  ...
  return (
    <div className="w-full">
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 flex items-center justify-between">
        ...
        <button onClick={()=>navigate("/fileITR/addPanCardDetail")} className="px-4 py-2 text-blue-500 font-medium bg-white border-2 border-blue-500 rounded-lg hover:bg-blue-50 transition-colors">
          Link your PAN
        </button>
      </div>
    </div>
