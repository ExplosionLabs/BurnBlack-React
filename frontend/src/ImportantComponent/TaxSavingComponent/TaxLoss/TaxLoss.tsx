   ...
   <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-medium text-gray-900 text-base"> Carry Forward Loss, AIS & Other Information</h3>
            <p className="text-sm text-gray-500 mt-1 ">
            Other less popular details like Carry Forward of Losses,<br />
             Foreign Assets, Directorship etc.
            </p>
          </div>
        </div>
        <div className="flex items-center space-x-4">
          <Link
          to="/tax-saving/other-tax"
