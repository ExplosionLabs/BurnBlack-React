  ...
  return (
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 className="font-medium text-gray-900 text-base"> Foreign Assets, Incomes & Taxes</h3>
          <p className="text-sm text-gray-500 mt-1 ">
          Do you have any Foreign Assets or Income? Or have you paid taxes outside India?
