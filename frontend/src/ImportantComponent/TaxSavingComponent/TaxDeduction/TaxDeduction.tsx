   ...
   <div className="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-medium text-gray-900 text-base"> Tax Savings Deductions</h3>
            <p className="text-sm text-gray-500 mt-1 ">
            80C (PPF, Insurance, ELSS etc.), 80CCC, 80CCD(1) and (1B), 80CCD(2),<br /> Interest earned on Savings Bank Account
            </p>
          </div>
        </div>
        <div className="flex items-center space-x-4">
          <Link
          to="/tax-saving/dashboard"
