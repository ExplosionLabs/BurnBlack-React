    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-medium text-gray-900 text-base"> Taxes collected at source</h3>
            <p className="text-sm text-gray-500 mt-1 ">
            Add TCS paid on expenses such as purchase of vehicles, foreign travels etc.
