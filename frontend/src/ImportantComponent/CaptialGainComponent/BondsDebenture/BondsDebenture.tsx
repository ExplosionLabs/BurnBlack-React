...
const BondsDebentureForm: React.FC<FormProps> = ({
  formData,
  step,
  handleInputChange,
  handleNext,
  ...
  return (
    <>
      {step === 1 && (
        <div>
          <h2 className="text-lg font-bold mb-4">Bond Debenture Data</h2>
          <div className="mb-4">
            ...
            >
                ...
                <>
                  ...
                  <option value="Listed Debenture">Listed Debenture</option>
                  <option value="Non Listed Debenture">
                  Non Listed Debenture
                  </option>
      ...
      {step === 2 && (
        <div>
          ...
          <div className="mb-4">
            <label className="block text-gray-700">Sale Value *</label>
          ...
          <div className="mb-4">
            <label className="block text-gray-700">Transfer Expenses if any</label>
            <div className="flex items-center">
              <span className="mr-2">₹</span>
              <input
                type="number"
          ...
          <div className="mb-4">
            <label className="block text-gray-700">Purchase Price *
            * </label>
            <div className="flex items-center">
              <span className="mr-2">₹</span>
              <input
...
export default BondsDebentureForm;
