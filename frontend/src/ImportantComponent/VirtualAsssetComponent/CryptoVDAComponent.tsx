...
interface CryptoVDAComponentProps {
  formData: any;
  handleInputChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
  handleSubmit: () => void;
}

const CryptoVDAComponent: React.FC<CryptoVDAComponentProps> = ({
  formData,
  handleInputChange,
  handleSubmit,
}) => {
  ...
  return (
    <>
      <h2 className="text-xl font-bold mb-4">Add Crypto / VDA income yourself</h2>
...
export default CryptoVDAComponent;
