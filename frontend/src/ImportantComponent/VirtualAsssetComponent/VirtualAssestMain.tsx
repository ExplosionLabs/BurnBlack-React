...
export const VirtualAssestMain = () => {
  return (
      <>
    ...
    <div className="bg-white rounded-md shadow-sm border border-gray-100 overflow-hidden p-6">
         ...
         <div className="flex items-center justify-between">
           <div className="flex items-center gap-4">
             ...
             <div>
               <h3 className="font-medium text-gray-900 text-base">Crypto Income (Virtual Digital Assets - VDA)</h3>
               <p className="text-sm text-gray-500 mt-1 ">
               Crypto income from Trading, Staking, Mining, Minting, Gifts, NFT or other VDA assets
               </p>
             </div>
           </div>
           <div className="flex items-center space-x-4">
             <Link
                          to="/fileITR/incomeSources/virtual-assets"
