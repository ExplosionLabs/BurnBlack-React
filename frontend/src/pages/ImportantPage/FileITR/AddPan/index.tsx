  ...
  <div className="lg:col-span-2">
    <div className=" mx-auto p-6 lg:p-8">
      <div className="flex items-center justify-between gap-3 mb-6">
          <button className="flex bg-gray-200 p-1 hover:bg-gray-300 border border-gray-300 rounded-full items-center gap-2 text-gray-600 pr-3" onClick={() => navigate('/fileITR')}>
      ...
      <div className="flex items-center  mb-8">
            ...
            <p className="text-sm text-gray-500">This will help us fetch your details from the IT department.</p>
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-4">
            <div className="lg:w-1/2">
              <label htmlFor="pan" className="block text-sm font-semibold text-gray-800 mb-1 ">
              PAN Card Number
              </label>
              <input
                type="text"
                ...
                maxLength={10}
              />
              <p className="mt-1 text-xs text-gray-500">Enter a valid PAN number (e.g., ABCDE1234F)</p>
            </div>
            <div className="lg:w-1/2">
              <label htmlFor="dob" className="block text-sm font-semibold text-gray-800 mb-1">
                Date of Birth
              </label>
              <input
                type="date"
              ...
              />
              <p className="mt-1 text-xs text-gray-500">Specify date in a format like DD/MM/YYYY</p>
            </div>
          </div>

          {/* OTP Verification Method */}
          <div className="justify-between align-middle justify-center  mt-9">
            <h3 className="text-sm font-semibold text-gray-800 mt-9">Choose a method to verify OTP</h3>
            <p className="text-gray-500 text-xs">OTP helps to verify your identity with the Income Tax Department.</p>
            <div className="flex flex-col lg:flex-row gap-4 mt-5">
              <label
              className={`flex flex-col items-center gap-2 p-3 cursor-pointer border rounded-lg ${
                verificationMethod === 'it' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'
              }`}
              ...
              <img
                ...
                className="w-15 h-10"
              />
              <span className="text-gray-700 text-center px-4">IT Department registered mobile number</span>
              </label>

              <label
              className={`flex flex-col items-center gap-2 p-3 cursor-pointer border rounded-lg ${
                verificationMethod === 'aadhaar' ? 'border-blue-500 bg-blue-50' : 'border-gray-300'
              }`}
              ...
              <img
                ...
                className="w-15 h-10"
              />
              <span className="text-gray-700 text-center px-4">Aadhaar registered mobile number</span>
              </label>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 mt-5 rounded-lg">
            ...
            <p className="text-xs">
              Burnblack is a Government authorized ERI license holder. Your data is 100% secure with BurnBlack.
            </p>
          </div>
      </div>
    </div>
